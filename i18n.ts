...
const resources = {
  en: {
    translation: {
      ...
      forms: {
        ...
        yes: "Yes",
        no: "No",
        handyman: "Handyman/Repairing",
        electrical: "Electrical, plumbing, or Carpentry",
        tutoring: "Tutoring",
        cleaning: "Cleaning",
        childcare: "Childcare",
        other: "Other (please specify)",
        serviceOtherPlaceholder: "Please specify your service",
        ...
        ukStatusQuestion: "Your current status in the UK (select all that apply)",
        statusWorkingProfessional: "Working Professional",
        statusStudent: "Student",
        statusNewImmigrant: "New Immigrant / New to City",
        statusJobSeeker: "Job Seeker",
        statusRetired: "Retired",
        statusChurchLeader: "Church Leader / Ministry Worker",
        statusOther: "Other (please specify)",
        statusOtherPlaceholder: "Please specify your status",
  ...
  zh: {
    translation: {
      ...
      forms: {
        servicesOffered: "可提供的服務",
        churchAffiliation: "你平常有去教會嗎",
        churchName: "教會名稱",
        status: "你現在於英國的狀況（可多選)",
        keyFeatures: "平台上期望的主要功能",
        email: "電子郵件",
        serviceNeeded: "想要的服務",
        mostImportantFactor: "最重要的因素",
        additionalExpectations: "其他期望 / 意見?",
        yes: "是",
        no: "否",
        // 室內裝修 (Indoor Renovation) 水電工程 (Plumbing & Electrical) 木工工程 (Carpentry) 油漆工程 (Painting) 維修工程 (Repair Work)
        handyman: "室內裝修 / 維修",
        electrical: "水電 / 木工工程",
        tutoring: "補習",
        cleaning: "清潔",
        childcare: "托兒",
        other: "其他（請說明）",
        serviceOtherPlaceholder: "請列明你的服務",
        reviews: "評論與評分",
        verification: "教會驗證",
        messaging: "應用內消息",
        payments: "安全支付",
        ...
        ukStatusQuestion: "你現在於英國的狀況（可多選)",
        statusWorkingProfessional: "在職工作人士",
        statusStudent: "留學生",
        statusNewImmigrant: "剛移民 / 初來報到這城市",
        statusJobSeeker: "找工作中",
        statusRetired: "退休人士",
        statusChurchLeader: "教會負責人／事工負責",
        statusOther: "其他（請說明）",
        statusOtherPlaceholder: "請列明你的狀況",
        expertiseLevel: "專業程度",
        professional: "專業",
        amateur: "業餘",
        beginner: "初學者",
